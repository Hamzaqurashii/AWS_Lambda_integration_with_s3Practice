...
var require_aws_lambda_multipart_parser = __commonJS({
  "node_modules/aws-lambda-multipart-parser/index.js"(exports, module2) {
...
var hello = async (event) => {
  ...
  const s3_response = await upload_s3(form, S32);
  return formatJSONResponse({ form, event });
};
var upload_s3 = async (form, S32) => {
  ...
  console.log(request);
  try {
    const data = await S32.upload(request).promise();
    return data;
  } catch (e) {
